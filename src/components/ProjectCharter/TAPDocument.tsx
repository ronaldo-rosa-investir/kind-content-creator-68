...
const TAPDocument: React.FC<TAPDocumentProps> = ({ 
  ...
  return (
    <>
      ...
      <div id="tap-content" className={`tap-container max-w-4xl mx-auto bg-white ${className}`}>
        {/* Cabeçalho do Documento */}
        <div className="text-center border-b-2 border-gray-300 pb-6 mb-8 print-section">
